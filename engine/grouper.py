...
class DCLTable:
    ...
    def lookup(self, diagnosis_code: str, adrg_code: str) -> int:
        ...
        Returns 0 if not found — safe default (no complexity inflation).
        DCL=0 diagnoses contribute nothing to ECCS regardless of position.
        """
...
class ARDRGGrouper:
    ...
    def __init__(
        ...
        self.mdc_pdx_lookup    = mdc_pdx_lookup or {}
